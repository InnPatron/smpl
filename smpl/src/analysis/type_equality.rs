...
pub fn equal_types_static(universe: &Universe, scoped_data: &ScopedData, 
    ...
    match (synthesis, constraint) {
        ...
        (Record {
            ...
            for (synth_field_id, synth_type) in synth_fields.iter() {
                ...
                equal_types_static(universe, scoped_data, typing_context,
        ...
        (Opaque { 
            ...
            for (synthesis, constraint) in synth_args.iter().zip(constraint_args.iter()) {
                equal_types_static(universe, scoped_data, typing_context,
                    synthesis, constraint, span)?;
            }
